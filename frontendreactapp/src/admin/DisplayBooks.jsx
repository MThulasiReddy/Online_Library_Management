...
const DisplayProduct = () => 
{
  ...
  return (
    <div className="container mt-4">
      <h3 style={{ textAlign: "center", textDecoration: "underline" }}>Display Book Details</h3> {/*Display Product Details*/}

      {error && <p className="text-danger text-center">{error}</p>}

      <div className="form-group mb-3">
        <label><strong>Select a Book:</strong></label> {/*select a product */}
        <select className="form-control" value={selectedId} onChange={handleSelection}>
          <option value="">-- Select Book --</option> {/*-- Select Product --*/}
