...
import ViewBooksByManager from './ViewBooksByManager';
  ...
  return (
    <div>
      <nav className="navbar">
        <div className="logo">Welcome Library Manager</div>
        <ul className="nav-links">
          ...
          <li><Link to="/viewbooksbymanager">View Books</Link></li>
      ...
      <Routes>
        ...
        <Route path="/viewbooksbymanager" element={<ViewBooksByManager/>} exact />
