...
export default function ViewAllEvents() {
  ...
  const handleBookClick = (eventId) => {
    ...
    // Optional: store the selected event ID if needed later
    sessionStorage.setItem("selectedEventId", eventId);

    // Redirect to Razorpay payment gateway
    window.location.href = "https://rzp.io/rzp/l9QD3Eph";
  };
  ...
  return (
    <div className="event-container">
      <h3 className="event-heading">Available Books</h3>
      <table className="event-table">
        ...
        <tbody>
          {filteredEvents.length > 0 ? (
            ...
            <tr>
              <td colSpan="9">No matching books found.</td>
            </tr>
          )}
        </tbody>
      </table>
